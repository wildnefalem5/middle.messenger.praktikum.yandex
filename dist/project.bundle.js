...
const http_transport_1 = __webpack_require__(3200);

class Api {
  constructor() {
    this._http = new http_transport_1.HTTPTransport("https://ya-praktikum.tech/api/v2");
    this._jsonHeaders = {
...
const api_1 = __webpack_require__(7819);

class AuthApi extends api_1.Api {
  signIn(options) {
    return this._http.post("/auth/signin", { ...options,
      headers: this._jsonHeaders
    });
  }

  signUp(options) {
    return this._http.post("/auth/signup", { ...options,
      headers: this._jsonHeaders
    });
  }
...
class ChatApi extends api_1.Api {
  create(options) {
    return this._http.post("/chats", { ...options,
      headers: this._jsonHeaders
    });
  }
  ...
  invite(options) {
    return this._http.put("/chats/users", { ...options,
      headers: this._jsonHeaders
    });
  }
...
const store_1 = __webpack_require__(624);

const router_1 = __webpack_require__(5990);

const auth_api_1 = __webpack_require__(3461);
...
class AuthController {
  constructor() {
    ...
    this._api = new auth_api_1.AuthApi();
    this._store = store_1.store;
...
const web_socket_1 = __webpack_require__(1520);

const chat_api_1 = __webpack_require__(8678);

const store_1 = __webpack_require__(624);

class ChatController {
  constructor() {
    this.startMessages = chatId => {
      this._api.getToken(chatId).then(token => {
        const user = store_1.store.getState().user;
        const socket = new web_socket_1.WebSocketApi();
        const baseUrl = "wss://ya-praktikum.tech/ws/chats";
        const url = `${baseUrl}/${user === null || user === void 0 ? void 0 : user.id}/${chatId}/${token}`;
        socket.start(url);
      });
    };
    ...
    this._api = new chat_api_1.ChatApi();
  ...
  loadMoreChat() {
    return this._api.loadMore().then(response => {
      ...
      store_1.store.setState("chats", chats);
    });
  }
  ...
  sendMessage(message) {
    ...
    if (socket) {
      socket.sendMessage(message, web_socket_1.WebSocketMessages.MESSAGE);
    }
  }
...
const user_api_1 = __webpack_require__(3429);
...
class UserController {
  constructor() {
    ...
    this._api = new user_api_1.UserApi();
    this._store = store_1.store;
...
class UserApi extends api_1.Api {
  updateProfile(options) {
    return this._http.put("/user/profile", { ...options,
      headers: this._jsonHeaders
    });
  }
  ...
  updatePassword(options) {
    return this._http.put("/user/password", { ...options,
      headers: this._jsonHeaders
    });
  }
...
const block_1 = __importDefault(__webpack_require__(7220)); // @ts-ignore


const template_hbs_1 = __importDefault(__webpack_require__(2753));

class Button extends block_1.default {
  render() {
    return this.compile(template_hbs_1.default, this._props);
  }
...
const template_hbs_1 = __importDefault(__webpack_require__(2881));

class Field extends block_1.default {
  render() {
    return this.compile(template_hbs_1.default, this._props);
  }
...
const template_hbs_1 = __importDefault(__webpack_require__(8587));
...
exports.PagePlaceholder = void 0;

const index_1 = __webpack_require__(5548);

const block_1 = __importDefault(__webpack_require__(7220)); // @ts-ignore


const template_hbs_1 = __importDefault(__webpack_require__(1474));

const button = new index_1.Button("button", {
  text: "go to chat",
  attr: {
...
class PagePlaceholder extends block_1.default {
  constructor(props) {
    super("div", {
      button,
      ...props
...
exports.PagePlaceholder = PagePlaceholder;
...
const template_hbs_1 = __importDefault(__webpack_require__(6323));

class Textarea extends block_1.default {
  render() {
    return this.compile(template_hbs_1.default, this._props);
  }
...
const index_1 = __webpack_require__(424);

exports.NotFoundPage = new index_1.PagePlaceholder({
  codeStatus: "404",
...
exports.ServiceWorkPage = void 0;

__webpack_require__(8387);

const index_1 = __webpack_require__(424);

exports.ServiceWorkPage = new index_1.PagePlaceholder({
  codeStatus: "500",
  title: "Service work",
...
exports.BackToChat = void 0;

const block_1 = __importDefault(__webpack_require__(7220)); // @ts-ignore


const template_hbs_1 = __importDefault(__webpack_require__(8153));

class BackToChat extends block_1.default {
  render() {
    return this.compile(template_hbs_1.default, this._props);
  }
...
const template_hbs_1 = __importDefault(__webpack_require__(7332));

class PasswordForm extends block_1.default {
  render() {
    return this.compile(template_hbs_1.default, this._props);
  }
...
const template_hbs_1 = __importDefault(__webpack_require__(308));

class UserForm extends block_1.default {
  constructor(tag, props) {
    super(tag, props);

    this._store.on(store_1.StoreEvents.UPDATED, () => {
      this.setProps({
...
exports.AccountPage = exports.AccountPageComponent = exports.toggleFormVisible = void 0;

const index_1 = __webpack_require__(6145);

const user_controller_1 = __webpack_require__(7835);

const auth_controller_1 = __webpack_require__(597);
...
const validate_1 = __webpack_require__(3675);

const index_2 = __webpack_require__(7827);

const index_3 = __webpack_require__(5186);

const show_form_data_console_1 = __webpack_require__(9239);

const index_4 = __webpack_require__(4717);

const index_5 = __webpack_require__(5548);

const block_1 = __importDefault(__webpack_require__(7220));

const input_1 = __webpack_require__(4173); // @ts-ignore


const template_hbs_1 = __importDefault(__webpack_require__(8982));

class AccountInput extends input_1.Input {
  constructor(props) {
    super("div", {
      events: {
        blur: e => {
          const input = e.target;
          const error = (0, validate_1.inputValidate)(input);

          if (error) {
            input === null || input === void 0 ? void 0 : input.setCustomValidity(error);
          }
        }
      },
      ...props
...
class UserFormField extends index_4.Field {
...
class PasswordFormField extends index_4.Field {
  constructor(label, input) {
    super("label", {
      label,
      attr: {
...
exports.toggleFormVisible = toggleFormVisible;
const editInfoButton = new index_5.Button("button", {
  text: "Edit info",
  attr: {
  ...
  events: {
    click: () => {
      (0, exports.toggleFormVisible)(userForm);
    }
  }
});
const changePasswordButton = new index_5.Button("button", {
  ...
  events: {
    click: () => {
      (0, exports.toggleFormVisible)(passwordForm);
    }
  }
});
const userFormSubmitButton = new index_5.Button("button", {
  text: "save",
  attr: {
...
const userForm = new index_2.UserForm("form", {
  ...
  events: {
    submit: e => {
      e.preventDefault();
      const form = e.target;
      const data = (0, show_form_data_console_1.getDataFromForm)(form);
...
const passwordFormSubmitButton = new index_5.Button("button", {
  text: "save",
  attr: {
...
const passwordForm = new index_3.PasswordForm("form", {
  ...
  events: {
    submit: e => {
      ...
      const form = e.target;
      const data = (0, show_form_data_console_1.getDataFromForm)(form);
      user_controller_1.userController.updatePassword({
        data
      });
    }
  }
});
const logoutButton = new index_5.Button("button", {
  text: "Log out",
  attr: {
...
const avatarInput = new input_1.Input("div", {
  name: "avatar",
  type: "file",
  attr: {
  ...
  events: {
    change: e => {
      ...
      if (file) {
        ...
        user_controller_1.userController.updateAvatar({
          data
        });
      }
    }
...
const avatarField = new index_4.Field("label", {
  label: "Change avatar",
  attr: {
...
const backToChat = new index_1.BackToChat('div', {
  attr: {
...
class AccountPageComponent extends block_1.default {
  constructor(tag, props) {
    super(tag, props);
    ...
    this._store.on(store_1.StoreEvents.UPDATED, () => {
      ...
      userFormSecondNameInput.setProps({
        value: user === null || user === void 0 ? void 0 : user.second_name
      });
      userFormDisplayNameInput.setProps({
        value: user === null || user === void 0 ? void 0 : user.display_name
      });
      ...
      userFormPhoneInput.setProps({
        value: user === null || user === void 0 ? void 0 : user.phone
      });
    });
  }
...
exports.AccountPage = new AccountPageComponent("div", {
  userForm,
  passwordForm,
  avatarField,
  editInfoButton,
...
exports.ChatCreatorForm = void 0;

const block_1 = __importDefault(__webpack_require__(7220)); // @ts-ignore


const template_hbs_1 = __importDefault(__webpack_require__(1397));

class ChatCreatorForm extends block_1.default {
  render() {
    return this.compile(template_hbs_1.default, this._props);
  }
...
exports.ChatCreatorForm = ChatCreatorForm;
...
const template_hbs_1 = __importDefault(__webpack_require__(1151));

class ChatHeader extends block_1.default {
  render() {
    return this.compile(template_hbs_1.default, this._props);
  }
...
const template_hbs_1 = __importDefault(__webpack_require__(6569));

class MessageForm extends block_1.default {
  render() {
    return this.compile(template_hbs_1.default, this._props);
  }
...
exports.ChatPage = exports.ChatPageComponent = void 0;

const index_1 = __webpack_require__(7801);

const store_1 = __webpack_require__(624);

const index_2 = __webpack_require__(3283);

const index_3 = __webpack_require__(4173);

const chat_controller_1 = __webpack_require__(3090);

const router_1 = __webpack_require__(5990);

const show_form_data_console_1 = __webpack_require__(9239);

const index_4 = __webpack_require__(1789);

const index_5 = __webpack_require__(4717);

const index_6 = __webpack_require__(6333);

const validate_1 = __webpack_require__(3675);

const index_7 = __webpack_require__(5548);
...
const template_hbs_1 = __importDefault(__webpack_require__(6528));

const chatHeader = new index_1.ChatHeader("div", {
  attr: {
    class: "chat-page__chat-header-title"
  },
  text: ""
});
const submitButton = new index_7.Button("button", {
  text: "Send",
  attr: {
...
const messageField = new index_5.Field("label", {
  attr: {
    class: "field"
  },
  input: new index_6.Textarea("div", {
    ...
    events: {
      blur: e => {
        const input = e.target;
        const error = (0, validate_1.checkMessage)(input.value) ? "" : "Wrong message";
        input === null || input === void 0 ? void 0 : input.setCustomValidity(error);
      }
    }
  })
});
const accountButton = new index_7.Button("button", {
  text: "Account",
  attr: {
  ...
  events: {
    click: () => {
      router_1.router.go("/settings");
    }
  }
});
const messageForm = new index_4.MessageForm("form", {
  messageField,
  submitButton,
  attr: {
  ...
  events: {
    submit: e => {
      ...
      const form = e.target;
      const data = (0, show_form_data_console_1.getDataFromForm)(form);
      chat_controller_1.chatController.sendMessage(data.message);
    }
  }
});
const chatCreatorInput = new index_3.Input("label", {
...
const chatCreatorButton = new index_7.Button("button", {
  text: "Create",
  attr: {
    class: "button",
    type: "submit"
...
const chatCreatorForm = new index_2.ChatCreatorForm("form", {
  chatCreatorInput,
  chatCreatorButton,
  attr: {
...
class ChatPageComponent extends block_1.default {
  constructor() {
    super("div", {
      messageForm,
      accountButton,
      ...
      events: {
        click: e => {
          ...
          if (target.hasAttribute("data-chat-id")) {
            ...
            chatHeader.setProps({
              text: target.dataset.chatTitle
            });

            if (chatId) {
              chat_controller_1.chatController.startMessages(+chatId);
            }
          }
        }
      }
    });
    chat_controller_1.chatController.loadMoreChat();
...
exports.ChatPage = new ChatPageComponent();
...
const template_hbs_1 = __importDefault(__webpack_require__(2529));

class LoginForm extends block_1.default {
  render() {
    return this.compile(template_hbs_1.default, this._props);
  }
...
exports.LoginPage = exports.LoginPageComponent = void 0;
...
const index_1 = __webpack_require__(4717);

const index_2 = __webpack_require__(5548);

const block_1 = __importDefault(__webpack_require__(7220));

const login_form_1 = __webpack_require__(8095);

const input_1 = __webpack_require__(4173); // @ts-ignore


const template_hbs_1 = __importDefault(__webpack_require__(2950));

class LoginInput extends input_1.Input {
  constructor(props) {
    super("div", {
      events: {
        blur: e => {
...
const button = new index_2.Button("button", {
  text: "sign in",
  attr: {
...
const emailField = new index_1.Field("label", {
  label: "Login",
  attr: {
...
const passwordField = new index_1.Field("label", {
  label: "Password",
  attr: {
    class: "field login-page__form-field"
  },
...
const loginForm = new login_form_1.LoginForm("form", {
  emailField,
  passwordField,
  button,
  attr: {
...
class LoginPageComponent extends block_1.default {
  constructor() {
    super("div", {
      loginForm
    });
    auth_controller_1.authController.getUser().then(user => {
      if (user) {
        store_1.store.setState('user', user);
        router_1.router.go("/messenger");
      }
    });
  }
...
exports.LoginPage = new LoginPageComponent();
...
const template_hbs_1 = __importDefault(__webpack_require__(18));

class RegistrationForm extends block_1.default {
  render() {
    return this.compile(template_hbs_1.default, this._props);
  }
...
exports.RegistrationPage = exports.RegistrationPageComponent = void 0;

const auth_controller_1 = __webpack_require__(597);

const validate_1 = __webpack_require__(3675);

const index_1 = __webpack_require__(3629);

const show_form_data_console_1 = __webpack_require__(9239);

__webpack_require__(8387);

const index_2 = __webpack_require__(4717);

const index_3 = __webpack_require__(5548);
...
const template_hbs_1 = __importDefault(__webpack_require__(4166));
...
const button = new index_3.Button("button", {
  text: "sign up",
  attr: {
    class: "button registration-page__form-button"
  }
});
const firstNameInput = new input_1.Input("div", {
  placeholder: "Enter your first name",
  name: "first_name",
  type: "text",
  events: {
...
const firstNameField = new index_2.Field("label", {
  label: "First name",
  attr: {
...
const secondNameInput = new input_1.Input("div", {
  placeholder: "Enter your second name",
  name: "second_name",
  type: "text",
  events: {
...
const secondNameField = new index_2.Field("label", {
  label: "Second name",
  attr: {
    class: "field registration-page__form-field"
  },
...
const loginInput = new input_1.Input("div", {
  placeholder: "Enter your login",
  name: "login",
  type: "text",
  events: {
...
const loginField = new index_2.Field("label", {
  label: "Login",
  attr: {
    class: "field registration-page__form-field"
  },
...
const emailInput = new input_1.Input("div", {
  placeholder: "Enter your email",
  name: "email",
  type: "email",
  events: {
...
const emailField = new index_2.Field("label", {
  label: "Email",
  attr: {
    class: "field registration-page__form-field"
  },
...
const phoneInput = new input_1.Input("div", {
  placeholder: "Enter your phone",
  name: "phone",
  type: "text",
  events: {
...
const phoneField = new index_2.Field("label", {
  label: "Phone",
  attr: {
    class: "field registration-page__form-field"
  },
...
const passwordInput = new input_1.Input("div", {
  placeholder: "Enter your password",
  name: "password",
  type: "password",
  events: {
...
const passwordField = new index_2.Field("label", {
  label: "Password",
  attr: {
    class: "field registration-page__form-field"
  },
...
const registrationForm = new index_1.RegistrationForm("form", {
  firstNameField,
  secondNameField,
  loginField,
  emailField,
...
class RegistrationPageComponent extends block_1.default {
  render() {
    return this.compile(template_hbs_1.default, this._props);
  }
...
exports.RegistrationPage = new RegistrationPageComponent("div", {
  registrationForm
});
...
const event_bus_1 = __importDefault(__webpack_require__(2023));
...
class Block {
  constructor(tag = "div", propsAndChildren) {
    ...
    this._eventBus = new event_bus_1.default();
...
exports.HTTPTransport = exports.METHODS = void 0;

const query_stringify_1 = __webpack_require__(9181);
...
class HTTPTransport {
  constructor(baseUrl) {
    this.get = (url, options = {}) => {
      const preparedUrl = options.data ? `${url}${(0, query_stringify_1.queryStringify)(options.data)}` : url;
      return this.request(preparedUrl, { ...options,
        method: METHODS.GET
...
const render_template_1 = __webpack_require__(3455);
...
class Route {
  ...
  render() {
    ...
    (0, render_template_1.renderTemplate)(this._props.rootQuery, this._block);
    return;
  }
...
const route_1 = __webpack_require__(6416);
...
class Router {
  ...
  use(pathname, block) {
    const route = new route_1.Route(pathname, block, {
...
exports.router = new Router("#root");
...
exports.getDataFromForm = void 0;
...
exports.store = exports.Store = exports.StoreEvents = void 0;

const event_bus_1 = __importDefault(__webpack_require__(2023));

const set_1 = __webpack_require__(8398);
...
class Store extends event_bus_1.default {
  ...
  setState(path, value) {
    (0, set_1.set)(this._state, path, value);
...
exports.inputValidate = exports.checkMessage = exports.passwordValidate = exports.phoneValidate = exports.emailValidate = exports.loginValidate = exports.nameValidate = void 0;
const REG_EXP = {
  name: /^[A-ZА-Я][a-zа-я]+$/,
  login: /^(?=.*[a-zA-Z])[\w-]{3,20}$/,
...
const inputValidate = input => {
  ...
  if (type.includes("name")) {
    return (0, exports.nameValidate)(value) ? "" : "Wrong name";
  }

  if (type.includes("password")) {
    return (0, exports.passwordValidate)(value) ? "" : "Wrong password";
  }

  if (type.includes("login")) {
    return (0, exports.loginValidate)(value) ? "" : "Wrong login";
  }

  if (type.includes("phone")) {
    return (0, exports.phoneValidate)(value) ? "" : "Wrong phone";
  }

  if (type.includes("email")) {
    return (0, exports.emailValidate)(value) ? "" : "Wrong email";
  }
};
...
exports.WebSocketApi = exports.WebSocketMessages = exports.WebsocketEvents = void 0;
...
(function (WebSocketMessages) {
  WebSocketMessages["PING"] = "ping";
  WebSocketMessages["PONG"] = "pong";
  WebSocketMessages["GET_OLD"] = "get old";
  WebSocketMessages["MESSAGE"] = "message";
  WebSocketMessages["FILE"] = "file";
})(WebSocketMessages = exports.WebSocketMessages || (exports.WebSocketMessages = {}));

class WebSocketApi extends event_bus_1.default {
  constructor() {
    super();
    this.isOpen = false;
    this.INTERVAL = 1000;
    ...
    this._handleMessage = event => {
      ...
      if (message.type === WebSocketMessages.MESSAGE) {
        ...
        const preparedMessage = { ...message,
          is_my_message: (user === null || user === void 0 ? void 0 : user.id) === message.user_id
        };
        store_1.store.setState("messages", [...prevStateMessages, preparedMessage]);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"label") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":1,"column":61}}})) != null ? stack1 : "")
    + "\r\n"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"input") || (depth0 != null ? lookupProperty(depth0,"input") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"input","hash":{},"data":data,"loc":{"start":{"line":2,"column":0},"end":{"line":2,"column":13}}}) : helper))) != null ? stack1 : "");
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<input\r\n  type=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"type") || (depth0 != null ? lookupProperty(depth0,"type") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"type","hash":{},"data":data,"loc":{"start":{"line":2,"column":8},"end":{"line":2,"column":16}}}) : helper)))
    + "\"\r\n  class=\"input\"\r\n  placeholder=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"placeholder") || (depth0 != null ? lookupProperty(depth0,"placeholder") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"placeholder","hash":{},"data":data,"loc":{"start":{"line":4,"column":15},"end":{"line":4,"column":30}}}) : helper)))
    + "\"\r\n  name=\""
    ...
    + "\"\r\n  "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"value") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":6,"column":2},"end":{"line":6,"column":39}}})) != null ? stack1 : "")
    + "\r\n/>";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"page-placeholder "
    + alias4(((helper = (helper = lookupProperty(helpers,"classList") || (depth0 != null ? lookupProperty(depth0,"classList") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"classList","hash":{},"data":data,"loc":{"start":{"line":1,"column":29},"end":{"line":1,"column":44}}}) : helper)))
    + "\">\r\n  <div class=\"container page-placeholder__container\">\r\n    <div class=\"page-placeholder__caption\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"codeStatus") || (depth0 != null ? lookupProperty(depth0,"codeStatus") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"codeStatus","hash":{},"data":data,"loc":{"start":{"line":3,"column":43},"end":{"line":3,"column":59}}}) : helper)))
    + "</div>\r\n    <h1 class=\"h1 page-placeholder__title\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"title") || (depth0 != null ? lookupProperty(depth0,"title") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data,"loc":{"start":{"line":4,"column":43},"end":{"line":4,"column":54}}}) : helper)))
    + "</h1>\r\n    <div class=\"page-placeholder__text\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"text") || (depth0 != null ? lookupProperty(depth0,"text") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"text","hash":{},"data":data,"loc":{"start":{"line":5,"column":40},"end":{"line":5,"column":50}}}) : helper)))
    + "</div>\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"button") || (depth0 != null ? lookupProperty(depth0,"button") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"button","hash":{},"data":data,"loc":{"start":{"line":6,"column":4},"end":{"line":6,"column":18}}}) : helper))) != null ? stack1 : "")
    + "\r\n  </div>\r\n</div>";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<svg\r\n  class=\"account-page__back-to-chat-arrow\"\r\n  viewBox=\"0 0 48 48\"\r\n  fill=\"none\"\r\n  xmlns=\"http://www.w3.org/2000/svg\"\r\n>\r\n  <path d=\"M29 34L19 24L29 14\" stroke=\"currentColor\" stroke-width=\"2\"></path>\r\n</svg>";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"account-page__user-form-fields\">\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"oldPasswordField") || (depth0 != null ? lookupProperty(depth0,"oldPasswordField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"oldPasswordField","hash":{},"data":data,"loc":{"start":{"line":2,"column":4},"end":{"line":2,"column":28}}}) : helper))) != null ? stack1 : "")
    + "\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"newPasswordField") || (depth0 != null ? lookupProperty(depth0,"newPasswordField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"newPasswordField","hash":{},"data":data,"loc":{"start":{"line":3,"column":4},"end":{"line":3,"column":28}}}) : helper))) != null ? stack1 : "")
    + "\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"repeatedNewPasswordField") || (depth0 != null ? lookupProperty(depth0,"repeatedNewPasswordField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"repeatedNewPasswordField","hash":{},"data":data,"loc":{"start":{"line":4,"column":4},"end":{"line":4,"column":36}}}) : helper))) != null ? stack1 : "")
    + "\r\n</div>\r\n"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"button") || (depth0 != null ? lookupProperty(depth0,"button") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"button","hash":{},"data":data,"loc":{"start":{"line":6,"column":0},"end":{"line":6,"column":14}}}) : helper))) != null ? stack1 : "");
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"account-page__user-form-fields\">\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"firstNameField") || (depth0 != null ? lookupProperty(depth0,"firstNameField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"firstNameField","hash":{},"data":data,"loc":{"start":{"line":2,"column":4},"end":{"line":2,"column":26}}}) : helper))) != null ? stack1 : "")
    + "\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"secondNameField") || (depth0 != null ? lookupProperty(depth0,"secondNameField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"secondNameField","hash":{},"data":data,"loc":{"start":{"line":3,"column":4},"end":{"line":3,"column":27}}}) : helper))) != null ? stack1 : "")
    + "\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"displayNameField") || (depth0 != null ? lookupProperty(depth0,"displayNameField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"displayNameField","hash":{},"data":data,"loc":{"start":{"line":4,"column":4},"end":{"line":4,"column":28}}}) : helper))) != null ? stack1 : "")
    + "\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"loginField") || (depth0 != null ? lookupProperty(depth0,"loginField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"loginField","hash":{},"data":data,"loc":{"start":{"line":5,"column":4},"end":{"line":5,"column":22}}}) : helper))) != null ? stack1 : "")
    + "\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"emailField") || (depth0 != null ? lookupProperty(depth0,"emailField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"emailField","hash":{},"data":data,"loc":{"start":{"line":6,"column":4},"end":{"line":6,"column":22}}}) : helper))) != null ? stack1 : "")
    + "\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"phoneField") || (depth0 != null ? lookupProperty(depth0,"phoneField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"phoneField","hash":{},"data":data,"loc":{"start":{"line":7,"column":4},"end":{"line":7,"column":22}}}) : helper))) != null ? stack1 : "")
    + "\r\n</div>\r\n"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"button") || (depth0 != null ? lookupProperty(depth0,"button") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"button","hash":{},"data":data,"loc":{"start":{"line":9,"column":0},"end":{"line":9,"column":14}}}) : helper))) != null ? stack1 : "");
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"account-page\">\r\n  "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"backToChat") || (depth0 != null ? lookupProperty(depth0,"backToChat") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"backToChat","hash":{},"data":data,"loc":{"start":{"line":2,"column":2},"end":{"line":2,"column":20}}}) : helper))) != null ? stack1 : "")
    + "\r\n  <div class=\"account-page__main\">\r\n    <div class=\"container account-page__container\">\r\n      <div class=\"account-page__avatar\">\r\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,((stack1 = (depth0 != null ? lookupProperty(depth0,"user") : depth0)) != null ? lookupProperty(stack1,"avatar") : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data,"loc":{"start":{"line":6,"column":8},"end":{"line":22,"column":15}}})) != null ? stack1 : "")
    + "\r\n        "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"avatarField") || (depth0 != null ? lookupProperty(depth0,"avatarField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"avatarField","hash":{},"data":data,"loc":{"start":{"line":24,"column":8},"end":{"line":24,"column":27}}}) : helper))) != null ? stack1 : "")
    ...
    + alias5(alias4(((stack1 = (depth0 != null ? lookupProperty(depth0,"user") : depth0)) != null ? lookupProperty(stack1,"display_name") : stack1), depth0))
    + "</span>\r\n          </li>\r\n          <li class=\"account-page__info-list-item\">\r\n            <span class=\"account-page__info-list-item-name\">Email</span>\r\n            <span\r\n              class=\"account-page__info-list-item-value\"\r\n            >"
    + alias5(alias4(((stack1 = (depth0 != null ? lookupProperty(depth0,"user") : depth0)) != null ? lookupProperty(stack1,"email") : stack1), depth0))
    + "</span>\r\n          </li>\r\n          <li class=\"account-page__info-list-item\">\r\n            <span class=\"account-page__info-list-item-name\">First name</span>\r\n            <span\r\n              class=\"account-page__info-list-item-value\"\r\n            >"
    + alias5(alias4(((stack1 = (depth0 != null ? lookupProperty(depth0,"user") : depth0)) != null ? lookupProperty(stack1,"first_name") : stack1), depth0))
    + "</span>\r\n          </li>\r\n          <li class=\"account-page__info-list-item\">\r\n            <span class=\"account-page__info-list-item-name\">Second name</span>\r\n            <span\r\n              class=\"account-page__info-list-item-value\"\r\n            >"
    + alias5(alias4(((stack1 = (depth0 != null ? lookupProperty(depth0,"user") : depth0)) != null ? lookupProperty(stack1,"second_name") : stack1), depth0))
    + "</span>\r\n          </li>\r\n          <li class=\"account-page__info-list-item\">\r\n            <span class=\"account-page__info-list-item-name\">Phone</span>\r\n            <span\r\n              class=\"account-page__info-list-item-value\"\r\n            >"
    + alias5(alias4(((stack1 = (depth0 != null ? lookupProperty(depth0,"user") : depth0)) != null ? lookupProperty(stack1,"phone") : stack1), depth0))
    + "</span>\r\n          </li>\r\n        </ul>\r\n        <div class=\"account-page__info-buttons\">\r\n          "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"editInfoButton") || (depth0 != null ? lookupProperty(depth0,"editInfoButton") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"editInfoButton","hash":{},"data":data,"loc":{"start":{"line":61,"column":10},"end":{"line":61,"column":30}}}) : helper))) != null ? stack1 : "")
    + "\r\n          "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"changePasswordButton") || (depth0 != null ? lookupProperty(depth0,"changePasswordButton") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"changePasswordButton","hash":{},"data":data,"loc":{"start":{"line":62,"column":10},"end":{"line":62,"column":36}}}) : helper))) != null ? stack1 : "")
    + "\r\n        </div>\r\n        "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"logoutButton") || (depth0 != null ? lookupProperty(depth0,"logoutButton") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"logoutButton","hash":{},"data":data,"loc":{"start":{"line":64,"column":8},"end":{"line":64,"column":26}}}) : helper))) != null ? stack1 : "")
    + "\r\n      </div>\r\n\r\n      "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"userForm") || (depth0 != null ? lookupProperty(depth0,"userForm") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"userForm","hash":{},"data":data,"loc":{"start":{"line":67,"column":6},"end":{"line":67,"column":20}}}) : helper))) != null ? stack1 : "")
    + "\r\n\r\n      "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"passwordForm") || (depth0 != null ? lookupProperty(depth0,"passwordForm") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"passwordForm","hash":{},"data":data,"loc":{"start":{"line":69,"column":6},"end":{"line":69,"column":24}}}) : helper))) != null ? stack1 : "")
    + "\r\n    </div>\r\n  </div>\r\n</div>";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = ((helper = (helper = lookupProperty(helpers,"chatCreatorInput") || (depth0 != null ? lookupProperty(depth0,"chatCreatorInput") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"chatCreatorInput","hash":{},"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":1,"column":24}}}) : helper))) != null ? stack1 : "")
    + "\r\n"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"chatCreatorButton") || (depth0 != null ? lookupProperty(depth0,"chatCreatorButton") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"chatCreatorButton","hash":{},"data":data,"loc":{"start":{"line":2,"column":0},"end":{"line":2,"column":25}}}) : helper))) != null ? stack1 : "");
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = ((helper = (helper = lookupProperty(helpers,"messageField") || (depth0 != null ? lookupProperty(depth0,"messageField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"messageField","hash":{},"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":1,"column":20}}}) : helper))) != null ? stack1 : "")
    + "\r\n"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"submitButton") || (depth0 != null ? lookupProperty(depth0,"submitButton") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"submitButton","hash":{},"data":data,"loc":{"start":{"line":2,"column":0},"end":{"line":2,"column":20}}}) : helper))) != null ? stack1 : "");
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "                    <div class=\"chat-page__chats-item\" data-chat-id=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":6,"column":69},"end":{"line":6,"column":77}}}) : helper)))
    + "\" data-chat-title=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"title") || (depth0 != null ? lookupProperty(depth0,"title") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data,"loc":{"start":{"line":6,"column":96},"end":{"line":6,"column":107}}}) : helper)))
    + "\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"title") || (depth0 != null ? lookupProperty(depth0,"title") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data,"loc":{"start":{"line":6,"column":109},"end":{"line":6,"column":118}}}) : helper)))
    + "</div>\r\n";
},"3":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return "                <div class=\"chat-page__chat-messages-item "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"is_my_message") : depth0),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":20,"column":58},"end":{"line":20,"column":123}}})) != null ? stack1 : "")
    + "\">"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"content") || (depth0 != null ? lookupProperty(depth0,"content") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"content","hash":{},"data":data,"loc":{"start":{"line":20,"column":125},"end":{"line":20,"column":136}}}) : helper)))
    + "</div>\r\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "chat-page__chat-messages-item--myself";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.hooks.helperMissing, alias3="function", lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
  ...
  return "<div class=\"chat-page\">\r\n    <div class=\"chat-page__panel\">\r\n        <div class=\"chat-page__search chat-page__panel-header\"></div>\r\n        <div class=\"chat-page__chats chat-page__panel-body\">\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"chats") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":5,"column":16},"end":{"line":7,"column":25}}})) != null ? stack1 : "")
    + "        </div>\r\n        <div class=\"chat-page__panel-footer\">\r\n            "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"chatCreatorForm") || (depth0 != null ? lookupProperty(depth0,"chatCreatorForm") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"chatCreatorForm","hash":{},"data":data,"loc":{"start":{"line":10,"column":12},"end":{"line":10,"column":35}}}) : helper))) != null ? stack1 : "")
    + "\r\n        </div>\r\n    </div>\r\n    <div class=\"chat-page__chat\">\r\n        <div class=\"chat-page__chat-header\">\r\n            "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"chatHeader") || (depth0 != null ? lookupProperty(depth0,"chatHeader") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"chatHeader","hash":{},"data":data,"loc":{"start":{"line":15,"column":12},"end":{"line":15,"column":30}}}) : helper))) != null ? stack1 : "")
    + "\r\n            "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"accountButton") || (depth0 != null ? lookupProperty(depth0,"accountButton") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"accountButton","hash":{},"data":data,"loc":{"start":{"line":16,"column":12},"end":{"line":16,"column":33}}}) : helper))) != null ? stack1 : "")
    + "\r\n        </div>\r\n        <div class=\"chat-page__chat-messages\">\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"messages") : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":19,"column":12},"end":{"line":21,"column":21}}})) != null ? stack1 : "")
    + "        </div>\r\n        <div class=\"chat-page__chat-footer\">\r\n            "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"messageForm") || (depth0 != null ? lookupProperty(depth0,"messageForm") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"messageForm","hash":{},"data":data,"loc":{"start":{"line":24,"column":12},"end":{"line":24,"column":31}}}) : helper))) != null ? stack1 : "")
    + "\r\n        </div>\r\n    </div>\r\n</div>";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"login-page__form-fields\">\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"emailField") || (depth0 != null ? lookupProperty(depth0,"emailField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"emailField","hash":{},"data":data,"loc":{"start":{"line":2,"column":4},"end":{"line":2,"column":22}}}) : helper))) != null ? stack1 : "")
    + "\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"passwordField") || (depth0 != null ? lookupProperty(depth0,"passwordField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"passwordField","hash":{},"data":data,"loc":{"start":{"line":3,"column":4},"end":{"line":3,"column":25}}}) : helper))) != null ? stack1 : "")
    + "\r\n</div>\r\n"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"button") || (depth0 != null ? lookupProperty(depth0,"button") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"button","hash":{},"data":data,"loc":{"start":{"line":5,"column":0},"end":{"line":5,"column":14}}}) : helper))) != null ? stack1 : "");
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"login-page\">\r\n    <div class=\"container login-page__container\">\r\n        <h1 class=\"h2 login-page__form-title\">Login</h1>\r\n        "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"loginForm") || (depth0 != null ? lookupProperty(depth0,"loginForm") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"loginForm","hash":{},"data":data,"loc":{"start":{"line":4,"column":8},"end":{"line":4,"column":25}}}) : helper))) != null ? stack1 : "")
    + "\r\n    </div>\r\n</div>";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"registration-page__form-fields\">\r\n    "
    ...
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"secondNameField") || (depth0 != null ? lookupProperty(depth0,"secondNameField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"secondNameField","hash":{},"data":data,"loc":{"start":{"line":3,"column":4},"end":{"line":3,"column":27}}}) : helper))) != null ? stack1 : "")
    + "\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"loginField") || (depth0 != null ? lookupProperty(depth0,"loginField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"loginField","hash":{},"data":data,"loc":{"start":{"line":4,"column":4},"end":{"line":4,"column":22}}}) : helper))) != null ? stack1 : "")
    + "\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"emailField") || (depth0 != null ? lookupProperty(depth0,"emailField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"emailField","hash":{},"data":data,"loc":{"start":{"line":5,"column":4},"end":{"line":5,"column":22}}}) : helper))) != null ? stack1 : "")
    + "\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"phoneField") || (depth0 != null ? lookupProperty(depth0,"phoneField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"phoneField","hash":{},"data":data,"loc":{"start":{"line":6,"column":4},"end":{"line":6,"column":22}}}) : helper))) != null ? stack1 : "")
    + "\r\n    "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"passwordField") || (depth0 != null ? lookupProperty(depth0,"passwordField") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"passwordField","hash":{},"data":data,"loc":{"start":{"line":7,"column":4},"end":{"line":7,"column":25}}}) : helper))) != null ? stack1 : "")
    + "\r\n</div>\r\n"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"button") || (depth0 != null ? lookupProperty(depth0,"button") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"button","hash":{},"data":data,"loc":{"start":{"line":9,"column":0},"end":{"line":9,"column":14}}}) : helper))) != null ? stack1 : "");
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"registration-page\">\r\n    <div class=\"container registration-page__container\">\r\n        <h1 class=\"h2 registration-page__form-title\">Registration</h1>\r\n        "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"registrationForm") || (depth0 != null ? lookupProperty(depth0,"registrationForm") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"registrationForm","hash":{},"data":data,"loc":{"start":{"line":4,"column":8},"end":{"line":4,"column":32}}}) : helper))) != null ? stack1 : "")
    + "\r\n    </div>\r\n</div>";
},"useData":true});
...
const index_1 = __webpack_require__(7807);

const index_2 = __webpack_require__(7785);

const index_3 = __webpack_require__(4695);

const index_4 = __webpack_require__(3273);

const index_5 = __webpack_require__(4233);

const index_6 = __webpack_require__(4882);

const router = new router_1.Router("#root");
router.use("/", index_6.LoginPage).use("/sign-up", index_1.RegistrationPage).use("/messenger", index_4.ChatPage).use("/settings", index_5.AccountPage).use("/500", index_3.ServiceWorkPage).use("/404", index_2.NotFoundPage).start();
})();
